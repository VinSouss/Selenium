...
public class MovimentacaoTest extends BaseTest {
	...
	public void test1InserirMovimentacao(){
		...
		movPage.setConta("Conta para movimentaçoes");
...
//		Assert.assertTrue(erros.contains("Data da MovimentaÃ§Ã£o Ã© obrigatÃ³rio"));
		Assert.assertTrue(erros.containsAll(Arrays.asList(
				...
				"Descrição é obrigatatório", "Interessado é obrigatório", 
	...
	public void test3InserirMovimentacaoFutura(){
		...
		movPage.setDescricao("MovimentaÃ§Ã£o do Teste");
		movPage.setInteressado("Interessado Qualquer");
		movPage.setValor("500");
		...
		List<String> erros = movPage.obterErros();
		Assert.assertTrue(
				erros.contains("Data da Movimentação deve ser menor ou igual á  data atual"));
